...
WebUI.selectOptionByValue(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
    'Hongkong CURA Healthcare Center', true)

WebUI.click(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/label_Apply for hospital readmission'))

WebUI.click(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/label_Medicaid'))

WebUI.setText(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'), 
    '01012024')
